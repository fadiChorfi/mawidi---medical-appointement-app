...
const styles = StyleSheet.create({
  ...
  tabText: {
    fontSize: 16,
    color: "#0b0b0b", // --color-black-text (inactive)
    fontFamily: "Aeonik-Regular", // --font-family-regular
  },
  activeTabText: {
    fontWeight: "600",
    color: "#20504b", // --color-primary
    fontFamily: "Aeonik-Bold", // --font-family-bold
  },
  underline: {
    position: "absolute",
    bottom: 0,
    left: 0,
    borderRadius: 1.5,
    backgroundColor: "#20504b", // --color-primary
  },
  contentFlatList: {
    flex: 1,
  },
